"""
Django settings for j5project project.
...
#
#  heroku config:set DJANGO_SECRET_KEY='ww3a==ta$g)#ei&*)2c!wkg_6ib&7$f%*l3*#4(@*!ay82p*27'
# 
# and then read the secret key from the environment variable with:
#  SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
#
SECRET_KEY = 'ww3a==ta$g)#ei&*)2c!wkg_6ib&7$f%*l3*#4(@*!ay82p*27'
...
ROOT_URLCONF = 'j5project.urls'

# WSGI configuration
# See https://docs.djangoproject.com/en/1.7/howto/deployment/wsgi/
WSGI_APPLICATION = 'j5project.wsgi.application'

# Database
# https://docs.djangoproject.com/en/1.7/ref/settings/#databases
# Parse database configuration from DATABASE_URL using dj-database-url
# if the environment variable is not defined then default to j5project_db.sqlite3.
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///"+os.path.join(BASE_DIR, 'j5project_db.sqlite3')),
}
